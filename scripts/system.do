...
add wave -noupdate -expand -group RFILE -expand -group rs /system_tb/DUT/CPU/DP/RF/rfif/rsel1
add wave -noupdate -expand -group RFILE -expand -group rs /system_tb/DUT/CPU/DP/RF/rfif/rdat1
add wave -noupdate -expand -group RFILE -expand -group rt /system_tb/DUT/CPU/DP/RF/rfif/rsel2
add wave -noupdate -expand -group RFILE -expand -group rt /system_tb/DUT/CPU/DP/RF/rfif/rdat2
add wave -noupdate -expand -group RFILE -expand -group rd /system_tb/DUT/CPU/DP/RF/rfif/wsel
